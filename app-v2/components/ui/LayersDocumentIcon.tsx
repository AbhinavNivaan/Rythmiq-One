...
interface LayersDocumentIconProps {
    size?: number;
    color?: string;
}

export default function LayersDocumentIcon({ size = 24, color = '#000000' }: LayersDocumentIconProps) {
    return (
        <View style={{ width: size, height: size, justifyContent: 'center', alignItems: 'center' }}>
            <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
                ...
                <Path d="M9 17H12" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
            </Svg>
        </View>
    );
}
